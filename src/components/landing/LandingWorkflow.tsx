    ...
    <section className={styles.workflow} id="workflow">
      ...
      >
        ...
        <p className={styles.sectionDesc}>
          Documents flow sequentially with role-based handoffs. Each step
          unlocks the next — the system enforces the business process
          automatically.
        </p>
      </div>
        ...
        {FLOW_STEPS.map((step, i) => (
          <React.Fragment key={step.label}>
            <div className={styles.flowStep}>
              <div
                className={`${styles.flowNode} ${step.highlight ? styles.flowNodeAmber : ""} ${step.success ? styles.flowNodeGreen : ""}`}
              >
                {step.icon}
              </div>
