    ...
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <div style={{ display: "flex", gap: "0.6rem", alignItems: "center" }}>
          ...
          <Button
            variant="ghost"
            onClick={() => router.push("/dashboard/sales/sale-order/analytics")}
          >
            ◎ Analytics
          </Button>
          <Button
            onClick={() => router.push("/dashboard/sales/sale-order/new")}
          >
            + New Sale Order
          </Button>
        </div>
                ...
                return (
                  <div className={styles.actions}>
                    <button
                      ...
                      onClick={() =>
                        router.push(`/dashboard/sales/sale-order/${v}`)
                      }
                    >
                      Edit
                    </button>
