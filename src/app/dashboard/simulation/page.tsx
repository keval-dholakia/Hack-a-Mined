        ...
        <div className={styles.page}>
            <div className={styles.header}>
                <div className={styles.titleGroup}>
                    <h1 className={styles.title}>Production <span>Simulation</span> &amp; Forecasting</h1>
                    <p className={styles.subtitle}>MPS → BOM Explosion → Capacity Planning → Cost Estimation</p>
                </div>
                {result && (
